...
--
-- Host: 127.0.0.1
-- Generation Time: Oct 27, 2025 at 02:18 AM
...
INSERT INTO `loaive` (`MLV`, `TenLV`, `MoTa`) VALUES
('LV01', 'Vé Standing', 'Đây là loại vé dành cho những khán giả yêu thích sự sôi động và muốn \"cháy\" hết mình cùng thần tượng. Khi sở hữu vé Standing, bạn sẽ được vào khu vực đứng (không có ghế ngồi) ngay gần sân khấu. Đây là lựa chọn hoàn hảo để tự do di chuyển, nhún nhảy và hòa mình vào đám đông, cảm nhận năng lượng của buổi biểu diễn một cách trọn vẹn nhất.'),
('LV02', 'Vé VIP', 'Trải nghiệm sự kiện với đẳng cấp cao nhất. Vé VIP mang đến cho bạn những đặc quyền độc quyền, bao gồm vị trí ngồi đẹp nhất, tầm nhìn thẳng và rõ ràng nhất ra sân khấu. Ngoài ra, vé VIP thường đi kèm các quyền lợi cộng thêm như lối đi riêng, khu vực phòng chờ sang trọng, đồ uống miễn phí và bộ quà tặng (merchandise) phiên bản giới hạn từ ban tổ chức.'),
('LV03', 'Vé thường', 'Đây là loại vé tiêu chuẩn, giúp bạn có mặt và thưởng thức trọn vẹn không khí của sự kiện. Vé thường cung cấp cho bạn một vị trí (thường là ghế ngồi) ở các khu vực phổ thông. Đây là lựa chọn cơ bản và tiết kiệm nhất, phù hợp với đại đa số khán giả muốn tham gia sự kiện.'),
('LV04', 'Vé Early Bird', 'Dành cho những fan hâm mộ nhanh tay nhất! Vé Early Bird là loại vé được mở bán trong một thời gian ngắn trước đợt bán vé chính thức, với mức giá cực kỳ ưu đãi (rẻ hơn giá vé gốc). Vé Early Bird có thể áp dụng cho nhiều khu vực khác nhau (như vé Thường hoặc vé Standing). Số lượng vé này luôn có hạn, vì vậy hãy \"săn\" ngay khi có cơ hội!'),
('LV05', 'Vé Combo', 'Đây là lựa chọn \"tất cả trong một\" hoàn hảo để bạn tận hưởng trọn vẹn trải nghiệm lễ hội âm nhạc kéo dài nhiều ngày. Gói Combo này được thiết kế để mang lại sự tiện lợi và tiết kiệm chi phí tối đa, thường bao gồm vé tham dự cho TẤT CẢ các ngày của sự kiện. Ngoài ra, gói vé có thể đi kèm các ưu đãi độc quyền của lễ hội như:\r\nKhu vực cắm trại (camping) riêng.\r\nCác coupon đồ ăn/uống (F&B vouchers).\r\nBộ vật phẩm (merchandise) độc quyền của lễ hội (áo phông, nón, túi...).\r\nLối đi riêng hoặc quyền lợi đặc biệt khác. Mua combo là cách tốt nhất để không bỏ lỡ bất kỳ khoảnh khắc nào của lễ hội!');
...
INSERT INTO `sukien` (`MaSK`, `TenSK`, `Gia`, `Tgian`, `img_sukien`, `mota`, `MaLSK`, `MaDD`, `luot_timkiem`, `luot_truycap`) VALUES
...
('SK04', '[CAT&MOUSE] CA SĨ NGÔ LAN HƯƠNG - TUỔI MỘNG MƠ', 400000, '2025-11-08', 'https://salt.tkbcdn.com/ts/ds/7d/ac/94/9eb9dd09edfa026840340f8c75d2b520.png', 'Với không gian được đầu tư hệ thống ánh sáng - âm thanh đẳng cấp quốc tế với sức chứa lên đến 350 người, cùng quầy bar phục vụ cocktail pha chế độc đáo bởi bartender chuyên nghiệp.\n\n20h00 - 8/11/2025 (Thứ 7) này tại Cat&Mouse, một đêm nhạc mới cùng âm hưởng trong trẻo và trẻ trung.\n\nVới sự góp mặt của nàng ca sĩ - nhạc sĩ tài năng Ngô Lan Hương với bản hit “Đi giữa trời rực rỡ” từng đoạt giải \"Bài hát hiện tượng của năm\" (Làn Sóng Xanh 2024), “Tuổi mộng mơ”, “Thà bỏ lỡ”,... cùng nhiều bài hát ngọt ngào và hoài niệm khác chờ bạn đến thưởng thức.', 'LSK01', 'HCM', 80, 50),
...
('SK12', 'RAVERSE #3: Clowns Du Chaos w/ MIKE WILLIAMS - Oct 31 (HALLOWEEN PARTY)', 450000, '2025-10-31', 'https://salt.tkbcdn.com/ts/ds/e0/71/b2/b213ce9427cfc01487c73df2ba849787.jpg', 'Sau những đêm cháy hết mình cùng DubVision và Maddix, RAVERSE đã chính thức quay trở lại và lần này, Raverse sẽ biến APLUS HANOI thành một RẠP XIẾC MA MỊ đúng nghĩa. Cùng chào đón Headliner – MIKE WILLIAMS, DJ/Producer top 72 DJ Mag - Người đứng sau hàng loạt hit Future Bounce tỉ lượt nghe, từng khuấy đảo những sân khấu lớn nhất thế giới Tomorrowland, Ultra Music Festival,... nay sẽ đổ bộ Raverse #3 mang theo năng lượng bùng nổ chưa từng có! ⚡Cánh cửa rạp xiếc sắp mở… Bạn đã sẵn sàng hóa thân, quẩy hết mình và bước vào thế giới hỗn loạn của RAVERSE chưa?', 'LSK02', 'HN', 65, 35),
