...
--
-- Host: 127.0.0.1
-- Generation Time: Nov 08, 2025 at 02:50 AM
...
('SK12', 'RAVERSE #3: Clowns Du Chaos w/ MIKE WILLIAMS - Oct 31 (HALLOWEEN PARTY)', '2025-10-31 20:00:00', 'https://salt.tkbcdn.com/ts/ds/e0/71/b2/b213ce9427cfc01487c73df2ba849787.jpg', 'Sau những đêm cháy hết mình cùng DubVision và Maddix, RAVERSE đã chính thức quay trở lại và lần này, Raverse sẽ biến APLUS HANOI thành một RẠP XIẾC MA MỊ đúng nghĩa. Cùng chào đón Headliner – MIKE WILLIAMS, DJ/Producer top 72 DJ Mag - Người đứng sau hàng loạt hit Future Bounce tỉ lượt nghe, từng khuấy đảo những sân khấu lớn nhất thế giới Tomorrowland, Ultra Music Festival,... nay sẽ đổ bộ Raverse #3 mang theo năng lượng bùng nổ chưa từng có! ⚡Cánh cửa rạp xiếc sắp mở… Bạn đã sẵn sàng hóa thân, quẩy hết mình và bước vào thế giới hỗn loạn của RAVERSE chưa?', 'LSK02', 'HN', 65, 35),
...
('VE049', 'Đã giữ chỗ', 'LV17', NULL),
('VE050', 'Đã giữ chỗ', 'LV17', NULL),
...
('VE058', 'Đã giữ chỗ', 'LV20', NULL),
('VE059', 'Đã giữ chỗ', 'LV20', NULL),
('VE060', 'Đã giữ chỗ', 'LV20', NULL),
